...
class GameData:
    ...
    def get_closest_name_match(self, index: int, screenshotter: Screenshot, lang="en") -> tuple[str, int]:
        ...
        """
        name_from_image: str = get_achievement_name(index, screenshotter, lang=lang)
        max_cost: float = 0.
        max_name: str = ""
        max_id: int = -1
